...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://github.com/r0xtar/tg-mirror-leech-bot")
    buttons.buildbutton("Channel", "https://t.me/r0x74r")
...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>tg-mirror-leech-bot</b>.',
            context.bot,
            update,
            reply_markup,
        )
